...
This document defines how `kaos-pdf` handles features, bugs,
...
- What `kaos-pdf` version, platform, Python version, and installation
  method are involved?
...
- Fresh install smoke test that imports `kaos_pdf`.
